            ...
            <Block>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <Block style={styles.sliders}>
                        <Block margin={[10, 0]}>
                            <Text gray2 stlye={{ marginBottom: 10}}>Budget</Text>
                            <Slider
                                minimumValue={0}
                                maximumValue={1000}
                                style={{height: 19}}
                                ...
                                progressTrackColor={theme.colors.secondary}
                                trackColor={'rgba(157, 163, 180, 0.10)'}
                        ...
                        <Block margin={[10, 0]}>
                        <Text gray2 stlye={{ marginBottom: 10}}>Monthly Cap</Text>
                            <Slider
                                minimumValue={0}
                                maximumValue={5000}
                                style={{height: 19}}
                                ...
                                onChange={value => this.setState({ monthly: value})}
                            />
